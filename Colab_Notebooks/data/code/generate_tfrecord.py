...
flags = tf._api.v2.compat.v1.app.flags
...
def create_tf_example(group, path, label_map):
    with tf._api.v2.io.gfile.GFile(os.path.join(path, "{}".format(group.filename)), "rb") as fid:
...
def main(_):
    writer = tf._api.v2.compat.v1.io.TFRecordWriter(FLAGS.output_path)
